...
prod-up:
	@echo "<í Starting production services with external database..."
...
prod-up-ci:
	...
	@echo "=æ Starting development database..."
...
prod-down:
	@echo "=Ñ Stopping production services..."
...
prod-down-ci:
	@echo "=Ñ Stopping production services..."
	@docker-compose -f docker-compose.prod.yaml down
	@echo "=Ñ Stopping development database..."
